...
- Building tools that put **LLMs and agents** into the daily dev workflow
...
- Construindo ferramentas que colocam **LLMs e agentes** no dia a dia de desenvolvimento
...
**Também trabalho com / Also working with:** Pinia, Vue Router, Lumen, PHPUnit, Ollama, LLMs, agentes de IA e engenharia de prompts.
